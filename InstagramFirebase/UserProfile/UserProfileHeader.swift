...
//                    self.editProfileFollowButton.layer.borderColor = UIColor(white: 0, alpha: 0.2).cgColor
    ...
    @objc func handleEditProfileOrFollow() {
        ...
        if editProfileFollowButton.titleLabel?.text == "Unfollow" {
            Database.database().reference().child("following").child(currentLoggedInUserId).child(userId).removeValue { (err, dataref) in
                if let err = err {
    ...
    override init(frame: CGRect) {
        ...
        self.profileImageView.anchor(top: self.topAnchor, left: self.leftAnchor, bottom: nil, right: nil, paddingTop: 12, paddingLeft: 12, paddingBottom: 0, paddingRight: 0, width: 80, height: 80)
        ...
        self.usernameLabel.anchor(top: self.profileImageView.bottomAnchor, left: self.leftAnchor, bottom: self.gridButton.topAnchor, right: self.rightAnchor, paddingTop: 4, paddingLeft: 12, paddingBottom: 0, paddingRight: 12, width: 0, height: 0)
        
        self.setupStatsView()
        
        self.addSubview(self.editProfileFollowButton)
        self.editProfileFollowButton.anchor(top: self.postsLabel.bottomAnchor, left: self.postsLabel.leftAnchor, bottom: nil, right: self.followingLabel.rightAnchor, paddingTop: 2, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 34)
    }
    ...
    fileprivate func setupStatsView() {
        ...
        stackView.anchor(top: self.topAnchor, left: self.profileImageView.rightAnchor, bottom: nil, right: self.rightAnchor, paddingTop: 12, paddingLeft: 12, paddingBottom: 0, paddingRight: 12, width: 0, height: 50)
    }
